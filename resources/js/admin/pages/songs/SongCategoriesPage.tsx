...
const SongCategoriesPage: React.FC = () => {
  ...
  const [modal, setModal] = useState<{
    open: boolean;
    mode: 'create' | 'edit';
    category: Partial<SongCategory> | null;
  ...
  const [deleteModal, setDeleteModal] = useState<{ open: boolean; category: SongCategory | null }>({ open: false, category: null });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (modal.mode === 'edit' && modal.category?.id) {
        await songService.updateCategory(modal.category.id, formData);
      } else {
        await songService.createCategory(formData);
      }
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      await songService.deleteCategory(deleteModal.category.id);
    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in pb-12">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-h3 text-neutral-900 font-bold">Song Categories</h1>
            <p className="text-body-xs text-neutral-500">
              Organize songs into worship, praise, offering, communion, etc.
            </p>
          </div>
        </div>
        <button
      ...
      <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden shadow-xs">
        {loading ? (
          ...
          <div className="px-5 py-12 text-center">
            ...
            <p className="text-body-sm text-neutral-500 mb-4">No categories created yet</p>
            <button
              onClick={openCreateModal}
          ...
          <form onSubmit={handleSubmit} className="relative bg-white rounded-2xl shadow-xl max-w-lg w-full p-6 space-y-4 animate-scale-in">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Worship, Praise, Offering"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Short description of songs in this category..."
                className="w-full px-3.5 py-2 border border-neutral-200 rounded-lg text-body-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2 border border-neutral-200 rounded-lg text-body-sm bg-white focus:outline-none focus:ring-2 focus:ring-primary-500/20"
                >
...
export default SongCategoriesPage;
