...
class ChurchSettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'favicon', 'value' => '/images/logo.png', 'type' => 'string', 'group' => 'general'],
            ...
            ['key' => 'facebook', 'value' => 'https://www.facebook.com/profile.php?id=61583373172735', 'type' => 'string', 'group' => 'social'],
            ['key' => 'youtube', 'value' => 'https://www.youtube.com/@horaiosministrycambodia7430', 'type' => 'string', 'group' => 'social'],
